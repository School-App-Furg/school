...
mixin _$RegisterStudentController on _RegisterStudentControllerBase, Store {
  final _$classesAtom = Atom(name: '_RegisterStudentControllerBase.classes');
  ...
  final _$classesSelecionadasAtom =
      Atom(name: '_RegisterStudentControllerBase.classesSelecionadas');
  ...
  final _$getClassesAsyncAction =
      AsyncAction('_RegisterStudentControllerBase.getClasses');
